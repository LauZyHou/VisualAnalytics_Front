<template>
  <div id="MeanscoreStackWorld" class="childpan" :style="{width: '1000px', height: '280px'}"></div>
</template>
...
export default {
  ...
  methods: {
    drawLine () {
      ...
      let myChart = this.$echarts.init(document.getElementById('MeanscoreStackWorld'))
      // 绘制图表
      let option = {
        title: {
          text: '电影得分占比(世界)'
